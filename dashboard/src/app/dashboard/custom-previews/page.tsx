      ...
      <div className="bg-[#0d1117] border border-[#1f2937] rounded-xl p-4 mb-4">
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="flex-1 bg-[#161b22] border border-[#1f2937] rounded-lg px-3 py-2 text-sm text-white focus:border-violet-500 focus:outline-none max-w-xs"
          >
            {channels.map(c => (
        ...
        >
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
              activeTab === 'preview' ? 'bg-violet-500/20 text-violet-400' : 'bg-[#1f2937] text-gray-400'
            }`}>
